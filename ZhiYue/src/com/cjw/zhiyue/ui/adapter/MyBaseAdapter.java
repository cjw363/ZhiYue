package com.cjw.zhiyue.ui.adapter;

import java.util.List;

import com.cjw.zhiyue.R;
import com.cjw.zhiyue.ui.holder.BaseHolder;
import com.cjw.zhiyue.ui.holder.MoreHolder;
 ...
 * @param <T>表示传入的数据为未知
 */
public abstract class MyBaseAdapter<T> extends RecyclerView.Adapter<BaseHolder<T>> {
	...
	public BaseHolder onCreateViewHolder(ViewGroup parent, int viewType) {
		if (viewType == TYPE_FOOTER_ITEM) {
			View moreView = LayoutInflater.from(UIUtils.getContext()).inflate(R.layout.layout_load_more, parent, false);
