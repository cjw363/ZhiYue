...
import com.cjw.zhiyue.ui.activity.BaseActivity;
...
public class PagerTab extends ViewGroup {
	...
	private int mDividerWidth = 0;// 分割线的宽度
	private int mDividerColor = 0xfff;//分割线颜色默认0x1A000000
	private Paint mDividerPaint;//分割线的画笔

	private int mIndicatorHeight = 1;//指示器的高度
	private int mIndicatorWidth;//指示器的宽度，是动态的随着tab的宽度变化
	private int mIndicatorLeft;//指示器的距离左边的距离
	private int mIndicatorColor = 0xFF47CAFF;//指示器颜色
	...
	private void addTextTab(final int position, String title) {
		...
		tab.setTypeface(Typeface.defaultFromStyle(Typeface.BOLD));//设置字体粗细
