package com.cjw.zhiyue.ui.view.libs.lrc.impl;

import java.util.List;

import com.cjw.zhiyue.ui.view.libs.lrc.ILrcView;
import com.cjw.zhiyue.ui.view.libs.lrc.ILrcViewListener;
...
public class LrcView extends View implements ILrcView {
     ...
     * 当前高亮歌词的字体颜色为蓝色
     */
    private int mHignlightRowColor = Color.BLACK;
    /**
     * 不高亮歌词的字体颜色为黑色
     */
     ...
     * 歌词字体大小默认值
     **/
    private int mLrcFontSize = UIUtils.dip2px(18);    // font size of lrc
    /**
     * 歌词字体大小最小值
     **/
    private int mMinLrcFontSize = UIUtils.dip2px(15);
    /**
     * 歌词字体大小最大值
     **/
    private int mMaxLrcFontSize = UIUtils.dip2px(20);

    /**
     * 两行歌词之间的间距
     **/
    private int mPaddingY = UIUtils.dip2px(18);
    /**
