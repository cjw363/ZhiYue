...
public class UIUtils {
	...
	public static Context getContext() {
		return ZhiYueApplication.getContext();
	}

	public static Handler getHandler() {
		return ZhiYueApplication.getHandler();
	}

	public static int getMainThreadId() {
		return ZhiYueApplication.getMainThreadId();
	}
	// /////////////////获取Activity ///////////////////////////
	public static void putActivity(Activity activity){
		ZhiYueApplication.putActivity(activity);
	}
	
	public static Activity getActivity(){
		return ZhiYueApplication.getActivity();
	}
